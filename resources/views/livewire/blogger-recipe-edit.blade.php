    ...
    <form wire:submit.prevent="update">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="name" id="name" type="text" class="form-control" placeholder="請輸入食譜名稱" value="{{$recipe->name}}" wire:model="recipe.name">
            </div>
                    ...
                    <div class="carousel-inner">
                        @foreach ($recipe->recipeImgs as $key=> $recipeImg)
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                ...
                                <button class="btn btn-danger btn-sm" style="position: absolute; top: 0; right: 0; z-index: 1;" wire:click.prevent="removeImage({{ $key }})">刪除</button>
                            </div>
                        @endforeach
                    </div>

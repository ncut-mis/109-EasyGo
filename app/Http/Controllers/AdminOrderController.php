...
class AdminOrderController extends Controller
{
    ...
    {
        $orders = Order::orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //取消申請訂單列表
        $orders = Order::where('status','=','7')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //已完成訂單列表
        $orders = Order::where('status','=','5')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //待審核訂單列表
        $orders = Order::where('status','=','0')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //已審核訂單列表
        $orders = Order::where('status','=','1')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //出貨中訂單列表
        $orders = Order::where('status','=','2')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //已出貨訂單列表
        $orders = Order::where('status','=','3')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //已送達訂單列表
        $orders = Order::where('status','=','4')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
    ...
    {
        //已取消訂單列表
        $orders = Order::where('status','=','6')->orderBy('updated_at','DESC')->orderBy('id','DESC')->get();//取得資料庫中的欄位值，以陣列的方式
        $data=[
            'orders'=>$orders
        ];
